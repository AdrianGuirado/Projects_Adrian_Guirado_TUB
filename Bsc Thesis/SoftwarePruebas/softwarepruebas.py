...
while True:
    ...
    if choice == '1':
        ...
        port.reset_input_buffer
        port.reset_output_buffer
        horizontal = input("Enter horizontal distance: ")
        vertical = input("Enter vertical distance: ")
        sample = input("Enter sample number: ")
        Spreading = input("Enter SF: ")

        nom = "data" + "_" + horizontal + "_" + vertical + "_" + sample + "_" + Spreading + ".csv"
        begin = "B"
        ...
        vertical = input("Enter vertical distance: ")
        sample = input("Enter sample number: ")
        delete_file = "data" +"_" + horizontal + "_" + vertical + "_" + sample + ".csv"
        ...
        file_path = "data" + "_" + horizontal + "_" + vertical + "_" + sample + ".csv"
        ...
        plt.title('RSSI Value for 10 Meters')
        ...
        RSSI = RSSI.sort_values('Horizontal Axis')
        SNR = SNR.sort_values('Horizontal Axis')

        for value in np.sort(RSSI['Vertical Axis'].unique()):
            temp_df = RSSI[RSSI['Vertical Axis'] == value]
            print(temp_df)
            plt.plot(temp_df['Horizontal Axis'], temp_df['RSSI'], label=f'Horizontal distance = {value} m')
